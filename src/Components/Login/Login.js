            ...
            <Card className="p-3 shadow">
              ...
              <div>
                ...
                <Form onSubmit={handleRegistration} className="mt-3">
                  ...
                  <Button type="submit">
                    <BiLogIn size="16px" /> {isLogin ? "Login" : "Register"}
                  </Button>
                  <br />
                  {user.email ? (
                    <p>
                      Login SuccessFull !! Wellcome {user.email}{" "}
                      <Link className="text-primary fw-bold" to="/home">
                  ...
                  <div className="form-check mt-5 ">
                    <input
                      ...
                      className="ms-3 form-check-input border border-danger shadow shadow-4"
                      type="checkbox"
                      value=""
                      id="gridCheck1"
                    />
